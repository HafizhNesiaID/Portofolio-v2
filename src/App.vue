<template>
    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-lg text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">HafizhXD();</span>
        </button>
  ...
  <nav class="flex justify-around py-4 text-xs">
    ...
    <router-link to="/portfolio" class="text-gray-300 hover:text-white">Certificate</router-link>
